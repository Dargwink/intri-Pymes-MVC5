...
namespace PymesS.A
{
    public class EmailService : IIdentityMessageService
    {
        ...
        public Task SendAsync(IdentityMessage message)
        {
            ...
            System.Net.NetworkCredential credentials = new System.Net.NetworkCredential(CRMFacilito2.Generales.EmailEnvio, CRMFacilito2.Generales.contraseniaEmail);
            ...
            try
            {
                var mail = new MailMessage(CRMFacilito2.Generales.EmailEnvio.Trim(), message.Destination.Trim());
